...
wrap_dir = "blender_show_hide_sockets_addon"  # Wrap the output in a directory in the ZIP file
output_file = f"blender_show_hide_sockets_addon_{tag_name}.zip"  # What to call the ZIP file
